# coding: utf-8
# This template has been based off the CAPE Sandbox Connector Template
# https://github.com/OpenCTI-Platform/connectors/pull/533
...
class TemplateConnector:
    def __init__(self):
        ...
        # Connector variables
        self.variable_1 = get_config_variable(
            "TEMPLATE_SERVICE_VARIABLE_1", ["variable_1", "url"], config
        )
        self.variable_2 = get_config_variable(
            "TEMPLATE_SERVICE_VARIABLE_2", ["variable_2", "url"], config
        )
    ...
    def _trigger_analysis(self, observable):
        self.helper.log_info("Triggering the analysis...")
    ...
    def _process_observable(self, observable):
        ...
        if observable["entity_type"] in ["StixFile", "Artifact"]:
            return self._trigger_analysis(observable)
        else:
            raise ValueError(
